...
public class AddMembersGroup implements Initializable {
    @FXML
                    ...
                    for(Object o : selected){
                        try {
                            if (getIndex() < users.size()){
                                if (HomePageController.selectedGroup != null){
                                    String member = users.get(getIndex()).getUsername();
                                    if(checkIfMember(member, HomePageController.selectedGroup)){
                                        addGroupMemberToDatabse(member, HomePageController.selectedGroup);
                                        notifLBL.setText(member + " added to your group!");
                                    }else{
                                        notifLBL.setText(member + " already exist in the group!");
                                    }
                                }
